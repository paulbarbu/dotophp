...
<tr><td>
<label for="name">Name:</label></td><td><input type="text" maxlength="20" name="name" id="name" tabindex="3"
 <?php echo isset($_POST['name']) ? 'value="' . $_POST['name'] . '"' : NULL ?> /></td><td>

<label for="desc">Description:</label></td><td><textarea tabindex="4" rows="3" cols="23" name="description" id="desc">
...
<input type="submit" name="add" value="Add" /></center></td></tr>
</form>
