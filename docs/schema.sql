...
CREATE TABLE `alarm` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `alarm_ibfk_1` FOREIGN KEY (`id`) REFERENCES `event` (`event_id`) ON DELETE CASCADE
...
CREATE TABLE `category` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `category_ibfk_1` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `friends` (
  ...
  CONSTRAINT `friends_ibfk_1` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `pending` (
  ...
  KEY `id` (`id`),
  CONSTRAINT `pending_ibfk_1` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2011-08-24 20:40:11
